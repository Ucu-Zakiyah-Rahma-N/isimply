            ...
            <form id="invoiceForm" action="{{ route('finance.invoice.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        @forelse ($invoice_sebelumnya as $inv)
                            <input type="text" class="form-control" value="{{ $inv->no_invoice }}" readonly>
                        @empty
                        ...
                        <div class="row align-items-end mb-2 item-row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control subtotal"
                                    value="{{ $izin->pivot->tipe_harga === 'gabungan' ? '' : ($izin->pivot->qty ?? 1) * ($izin->pivot->harga_satuan ?? 0) }}"
                                    readonly>
                            </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-md-6">
                        ...
                        <div class="mb-2 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="discountType" style="max-width:70px">
                        ...
                        <select class="form-select" name="tax[]" id="taxSelect" multiple>
                            @foreach ($ppnList as $ppn)
                                <option value="{{ $ppn->nilai_coa }}" data-name="{{ $ppn->nama_akun }}"
                                    data-type="{{ $ppn->jenis ?? 'ppn' }}">
                                    {{ $ppn->nama_akun }}
                                </option>
                            @endforeach
                ...
                <div id="ppnRow" class="mb-2 d-flex justify-content-between" style="display:none;">
                    ...
                    <span>Pajak (<span id="ppnRate">0</span>%)</span>
