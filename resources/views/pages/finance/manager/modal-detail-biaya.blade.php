...
<script>
    ...
    let modalDetailOnManager = null;

    document.addEventListener("DOMContentLoaded", function() {
        const modalEl = document.getElementById('modalPengajuanDetailBiaya');
        modalDetailOnManager = bootstrap.Modal.getOrCreateInstance(modalEl);
    });
    ...
    async function loadDetailPengajuanOnManager(id) {
